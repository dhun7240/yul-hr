...
export default function PayrollImportCard({
  uploading,
  hasSelection,
  onUpload,
  onEditSelected,
  onDeleteSelected,
  onDownloadTemplate,
}: PayrollImportCardProps) {
  const fileRef = useRef<HTMLInputElement | null>(null);

  return (
    <section className={`${cardClass()} max-w-[1180px]`}>
      <div className="text-xs font-extrabold tracking-wide text-orange-500">EXCEL INPUT</div>
